...
namespace ExpenseTracker.Api.Controllers
{
    ...
    public class WalletsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<WalletDto>>> GetAsync([FromQuery] QueryParametersBase queryParameters)
        {
        ...
        public async Task<ActionResult<WalletDto>> CreateAsync([FromBody] CreateWalletRequest request)
        {
            ...
            return CreatedAtAction(nameof(GetWalletByIdAsync), response, new { id = response.Id });
        }
